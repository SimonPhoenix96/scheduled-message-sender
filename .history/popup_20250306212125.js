...
function addAutoSaveListeners() {
    ...
    if (apiKeyInput) apiKeyInput.addEventListener('change', saveCurrentSettings);
    if (contextPromptInput) contextPromptInput.addEventListener('change', saveCurrentSettings);
