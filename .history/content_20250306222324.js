...
// In content.js, modify the postDonationMessage function
async function postDonationMessage(message, selector, shouldSend = true, showNotification = true) {
...
chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
  ...
  if (request.messages && request.messages.length > 0) {
    ...
    // Add notification for test success
