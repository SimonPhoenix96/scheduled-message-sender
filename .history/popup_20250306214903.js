...
document.addEventListener('DOMContentLoaded', function() {
  ...
  testButton.addEventListener('click', function() {
    ...
    function addMessageContainer(text = '', interval = 15, selector = '') {
        ...
        submitButton.className = 'submit-now-btn';
        ...
        submitButton.addEventListener('click', function() {
          ...
          chrome.tabs.sendMessage(tabs[0].id, {
            ...
            message: {
              text: messageText,
              selector: selectorInput.value || document.querySelector('.chat-selector').value || '#chat-input-wrapper > div > div.editor-input > p'
            }
          }, function(response) {  // Added the missing function parameter
