...
chrome.runtime.onInstalled.addListener(function() {
    chrome.storage.local.set({
      ...
      defaultInterval: 15,
      defaultSelector: 'body > div.group\/main.h-xvh.flex.flex-col > nav > div.flex.grow.items-center.justify-center.lg\:absolute.lg\:inset-x-96.lg\:inset-y-0 > div > div > input',
      useLLM: false,
      llmProvider: 'openai',
      apiKey: '',
      contextPrompt: ''
