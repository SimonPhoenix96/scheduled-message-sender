...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Only proceed with initialization if critical elements exist
    if (elements.toggleButton && elements.testButton) {
        initializeApp(elements);
    } else {
        console.error('Critical elements missing, cannot initialize app');
        if (elements.statusDiv) {
            elements.statusDiv.textContent = 'Error: UI elements missing';
            elements.statusDiv.className = 'status inactive';
        }
    }
});
