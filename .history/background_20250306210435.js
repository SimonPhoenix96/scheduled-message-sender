            ...
            if (chrome.runtime.lastError) {
              chrome.scripting.executeScript({
                ...
                chrome.tabs.sendMessage(tabId, {
                  ...
                  interval: tabSettings.interval, // Default interval as fallback
      ...
      chrome.storage.local.get('activeTabs', function(data) {
        if (data.activeTabs && data.activeTabs[tabId] && data.activeTabs[tabId].llmSettings?.useLLM) {
          ...
          generateMessage(
            ...
            const fallbackMessage = data.activeTabs[tabId].messages?.[0] || '';
          ...
          sendResponse({message: data.activeTabs[tabId]?.messages?.[0] || ''});
        }
      });
